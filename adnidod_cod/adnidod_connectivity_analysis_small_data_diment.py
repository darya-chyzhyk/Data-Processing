...
def draw_predictions(imgs=None, labels=None, index=None,
    ...
    learn_brain_regions = LearnBrainRegions(
        ...
        n_parcels=n_parcels,  # n_parcels = 120,
        n_comp=n_comp,  # n_comp=40,
        # n_clusters=120,
...
folder_name = dataname + '_iter' + str(n_iter) + '_smooth6_ica_dictlearn_kmeans_ward_dimen_1'
...
for model in models: #['kmeans']:
    for dim in dimensions:
        ...
        cvs_name = ('results_conf_models_dimension_' + str(n_iter) + 'iter_' + str(model) + '_' + str(dim) + 'dim.csv')
...
#results1_csv.to_csv(os.path.join(cache_path, 'results_conf_models_dimension_2iter_1.csv'))
